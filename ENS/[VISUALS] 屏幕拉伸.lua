...
local aspect_misc = gui.Groupbox(REF, "屏幕拉伸", 17, 790, 297)
local aspect_ratio_check = gui.Checkbox(aspect_misc, "aspect_ratio_check", "开启屏幕拉伸", false);  
local aspect_ratio_reference = gui.Slider(aspect_misc, "aspect_ratio_reference", "屏幕拉伸范围", 100, 1, 199)
