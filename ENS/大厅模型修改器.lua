...
local models = {
    {"隐藏"},
    {"鸡", "models/chicken/chicken.mdl"},
    {"堡垒之夜-粉红熊", "models/player/custom_player/legacy/cuddleleader.mdl"},
	{"本地T探员", "models/player/custom_player/legacy/tm_phoenix.mdl"},
	{"本地CT探员", "models/player/custom_player/legacy/ctm_sas.mdl"},
	{"Blackwolf", "models/player/custom_player/legacy/tm_balkan_variantj.mdl"},
	{"准备就绪的Rezan", "models/player/custom_player/legacy/tm_balkan_variantg.mdl"},
	{"Maximus", "models/player/custom_player/legacy/tm_balkan_varianti.mdl"},
	{"Dragomir", "models/player/custom_player/legacy/tm_balkan_variantf.mdl"},
	{"陆军少尉长官Ricksaw", "models/player/custom_player/legacy/ctm_st6_varianti.mdl"},
	{"'两次'McCoy", "models/player/custom_player/legacy/ctm_st6_variantm.mdl"},
	{"铅弹", "models/player/custom_player/legacy/ctm_st6_variantg.mdl"},
	{"海豹部队第六分队士兵", "models/player/custom_player/legacy/ctm_st6_variante.mdl"},
	{"第三特种兵连", "models/player/custom_player/legacy/ctm_st6_variantk.mdl"},
	{"'医生'", "models/player/custom_player/legacy/tm_balkan_varianth.mdl"},
	{"Michael Syfers", "models/player/custom_player/legacy/ctm_fbi_varianth.mdl"},
	{"Markus Delrow", "models/player/custom_player/legacy/ctm_fbi_variantg.mdl"},
	{"特种兵", "models/player/custom_player/legacy/ctm_fbi_variantf.mdl"},
	{"弹弓", "models/player/custom_player/legacy/tm_phoenix_variantg.mdl"},
	{"Enforcer | Phoenix", "models/player/custom_player/legacy/tm_phoenix_variantf.mdl"},
	{"执行者", "models/player/custom_player/legacy/tm_phoenix_varianth.mdl"},
	{"精英Muhlik先生", "models/player/custom_player/legacy/tm_leet_variantf.mdl"},
	{"Shahmat教授", "models/player/custom_player/legacy/tm_leet_varianti.mdl"},
	{"Osiris", "models/player/custom_player/legacy/tm_leet_varianth.mdl"},
	{"地面叛军", "models/player/custom_player/legacy/tm_leet_variantg.mdl"},
	{"Ava特工", "models/player/custom_player/legacy/ctm_fbi_variantb.mdl"},
	{"B Squadron指挥官", "models/player/custom_player/legacy/ctm_sas_variantf.mdl"},
	{"无政府主义者 A", "models/player/custom_player/legacy/tm_anarchist.mdl"},
	{"无政府主义者 B", "models/player/custom_player/legacy/tm_anarchist_varianta.mdl"},
	{"无政府主义者 C", "models/player/custom_player/legacy/tm_anarchist_variantb.mdl"},
	{"无政府主义者 D", "models/player/custom_player/legacy/tm_anarchist_variantc.mdl"},
	{"无政府主义者 E", "models/player/custom_player/legacy/tm_anarchist_variantd.mdl"},
	{"海盗 A", "models/player/custom_player/legacy/tm_pirate.mdl"},
	{"海盗 B", "models/player/custom_player/legacy/tm_pirate_varianta.mdl"},
	{"海盗 C", "models/player/custom_player/legacy/tm_pirate_variantb.mdl"},
	{"海盗 D", "models/player/custom_player/legacy/tm_pirate_variantc.mdl"},
	{"海盗 E", "models/player/custom_player/legacy/tm_pirate_variantd.mdl"},
	{"职业罪犯 A", "models/player/custom_player/legacy/tm_professional.mdl"},
	{"职业罪犯 B", "models/player/custom_player/legacy/tm_professional_var1.mdl"},
	{"职业罪犯 C", "models/player/custom_player/legacy/tm_professional_var2.mdl"},
	{"职业罪犯 D", "models/player/custom_player/legacy/tm_professional_var3.mdl"},
	{"职业罪犯 E", "models/player/custom_player/legacy/tm_professional_var4.mdl"},
	{"独立派 A", "models/player/custom_player/legacy/tm_separatist.mdl"},
	{"独立派 B", "models/player/custom_player/legacy/tm_separatist_varianta.mdl"},
	{"独立派 C", "models/player/custom_player/legacy/tm_separatist_variantb.mdl"},
	{"独立派 D", "models/player/custom_player/legacy/tm_separatist_variantc.mdl"},
	{"独立派 E", "models/player/custom_player/legacy/tm_separatist_variantd.mdl"},
	{"法国宪兵特勤队", "models/player/custom_player/legacy/ctm_gign.mdl"},
	{"法国宪兵特勤队 B", "models/player/custom_player/legacy/ctm_gign_varianta.mdl"},
	{"法国宪兵特勤队 C", "models/player/custom_player/legacy/ctm_gign_variantb.mdl"},
	{"法国宪兵特勤队 D", "models/player/custom_player/legacy/ctm_gign_variantc.mdl"},
	{"法国宪兵特勤队 E", "models/player/custom_player/legacy/ctm_gign_variantd.mdl"},
	{"德国联邦警察第九国境守备队 A", "models/player/custom_player/legacy/ctm_gsg9.mdl"},
	{"德国联邦警察第九国境守备队 B", "models/player/custom_player/legacy/ctm_gsg9_varianta.mdl"},
	{"德国联邦警察第九国境守备队 C", "models/player/custom_player/legacy/ctm_gsg9_variantb.mdl"},
	{"德国联邦警察第九国境守备队 D", "models/player/custom_player/legacy/ctm_gsg9_variantc.mdl"},
	{"德国联邦警察第九国境守备队 E", "models/player/custom_player/legacy/ctm_gsg9_variantd.mdl"},
	{"以色列国防军 A", "models/player/custom_player/legacy/ctm_idf.mdl"},
	{"以色列国防军 C", "models/player/custom_player/legacy/ctm_idf_variantb.mdl"},
	{"以色列国防军 D", "models/player/custom_player/legacy/ctm_idf_variantc.mdl"},
	{"以色列国防军 E", "models/player/custom_player/legacy/ctm_idf_variantd.mdl"},
	{"以色列国防军 F", "models/player/custom_player/legacy/ctm_idf_variante.mdl"},
	{"以色列国防军 G", "models/player/custom_player/legacy/ctm_idf_variantf.mdl"},
	{"特警 A", "models/player/custom_player/legacy/ctm_swat.mdl"},
	{"特警 B", "models/player/custom_player/legacy/ctm_swat_varianta.mdl"},
	{"特警 C", "models/player/custom_player/legacy/ctm_swat_variantb.mdl"},
	{"特警 D", "models/player/custom_player/legacy/ctm_swat_variantc.mdl"},
	{"特警 E", "models/player/custom_player/legacy/ctm_swat_variantd.mdl"},
    {"特别空勤团 A", "models/player/custom_player/legacy/ctm_sas.mdl"},
	{"特别空勤团 B", "models/player/custom_player/legacy/ctm_sas_varianta.mdl"},
	{"特别空勤团 C", "models/player/custom_player/legacy/ctm_sas_variantb.mdl"},
	{"特别空勤团 D", "models/player/custom_player/legacy/ctm_sas_variantc.mdl"},
	{"特别空勤团 E", "models/player/custom_player/legacy/ctm_sas_variantd.mdl"},
	{"海豹部队第六分队 A", "models/player/custom_player/legacy/ctm_st6.mdl"},
	{"海豹部队第六分队 B", "models/player/custom_player/legacy/ctm_st6_varianta.mdl"},
	{"海豹部队第六分队 C", "models/player/custom_player/legacy/ctm_st6_variantb.mdl"},
	{"海豹部队第六分队 D", "models/player/custom_player/legacy/ctm_st6_variantc.mdl"},
	{"海豹部队第六分队 E", "models/player/custom_player/legacy/ctm_st6_variantd.mdl"},
	{"巴尔干 A", "models/player/custom_player/legacy/tm_balkan_variante.mdl"},
	{"巴尔干 B", "models/player/custom_player/legacy/tm_balkan_varianta.mdl"},
	{"巴尔干 C", "models/player/custom_player/legacy/tm_balkan_variantb.mdl"},
	{"巴尔干 D", "models/player/custom_player/legacy/tm_balkan_variantc.mdl"},
	{"巴尔干 E", "models/player/custom_player/legacy/tm_balkan_variantd.mdl"},
	{"囚服 A", "models/player/custom_player/legacy/tm_jumpsuit_varianta.mdl"},
	{"囚服 B", "models/player/custom_player/legacy/tm_jumpsuit_variantb.mdl"},
	{"囚服 C", "models/player/custom_player/legacy/tm_jumpsuit_variantc.mdl"},
	{"凤凰战士 重甲", "models/player/custom_player/legacy/tm_phoenix_heavy.mdl"},
	{"反恐精英 重甲", "models/player/custom_player/legacy/ctm_heavy.mdl"},
	{"精锐分子 A", "models/player/custom_player/legacy/tm_leet_varianta.mdl"},
	{"精锐分子 B", "models/player/custom_player/legacy/tm_leet_variantb.mdl"},
	{"精锐分子 C", "models/player/custom_player/legacy/tm_leet_variantc.mdl"},
	{"精锐分子 D", "models/player/custom_player/legacy/tm_leet_variantd.mdl"},
	{"精锐分子 E", "models/player/custom_player/legacy/tm_leet_variante.mdl"},
	{"凤凰战士 A", "models/player/custom_player/legacy/tm_phoenix.mdl"},
	{"凤凰战士 B", "models/player/custom_player/legacy/tm_phoenix_varianta.mdl"},
	{"凤凰战士 C", "models/player/custom_player/legacy/tm_phoenix_variantb.mdl"},
	{"凤凰战士 D", "models/player/custom_player/legacy/tm_phoenix_variantc.mdl"},
	{"凤凰战士 E", "models/player/custom_player/legacy/tm_phoenix_variantd.mdl"},
	{"FBI A", "models/player/custom_player/legacy/ctm_fbi.mdl"},
	{"FBI B", "models/player/custom_player/legacy/ctm_fbi_varianta.mdl"},
	{"FBI D", "models/player/custom_player/legacy/ctm_fbi_variantc.mdl"},
	{"FBI E", "models/player/custom_player/legacy/ctm_fbi_variantd.mdl"},
	{"FBI F", "models/player/custom_player/legacy/ctm_fbi_variante.mdl"}
}

local dances = {
    {"无动作"},
    {"Biu~", "Emote_Fonzie_Pistol"},
    {"你过来啊", "Emote_Bring_It_On"},
    {"你不行事", "Emote_ThumbsDown"},
    {"你是真滴牛批", "Emote_ThumbsUp"},
    {"你妈飞了", "Emote_Celebration_Loop"},
    {"么么哒", "Emote_BlowKiss"},
    {"动动脑子想想", "Emote_Calculated"},
    {"一脸懵逼", "Emote_Confused",},
    {"小拳拳锤死你", "Emote_Chug"},
    {"呜呜呜我妈死了", "Emote_Cry"},
    {"完事了", "Emote_DustingOffHands"},
    {"拍拍肩膀的尘土", "Emote_DustOffShoulders",},
    {"真是令爷无语", "Emote_Facepalm"},
    {"钓鱼", "Emote_Fishing"},
    {"看看爷的肌肉", "Emote_Flex"},
    {"给你鼓鼓掌", "Emote_golfclap",},
    {"脑瘫的战术手势", "Emote_HandSignals"},
    {"欢呼雀跃", "Emote_HeelClick"},
    {"发骚", "Emote_Hotstuff"},
    {"给你J8都掰断", "Emote_IBreakYou",},
    {"比心", "Emote_IHeartYou"},
    {"抱拳", "Emote_Kung-Fu_Salute"},
    {"仰天大笑", "Emote_Laugh"},
    {"后空翻", "Emote_Luchador",},
    {"撒钱", "Emote_Make_It_Rain"},
    {"不行", "Emote_NotToday"},
    {"[猜拳] 布", "Emote_RockPaperScissor_Paper"},
    {"[猜拳] 石头", "Emote_RockPaperScissor_Rock",},
    {"[猜拳] 剪刀", "Emote_RockPaperScissor_Scissor"},
    {"蜜汁手势", "Emote_Salt"},
    {"帝国最高の礼仪", "Emote_Salute"},
    {"娘炮扭屁股", "Emote_SmoothDrive",},
    {"响指", "Emote_Snap"},
    {"鞠躬", "Emote_StageBow",},
    {"挥手", "Emote_Wave2"},
    {"爽", "Emote_Yeet"},
    {"傻逼舞1", "DanceMoves"},
    {"傻逼舞2", "Emote_Zippy_Dance"},
    {"傻逼舞3", "ElectroShuffle"},
    {"傻逼舞4", "Emote_AerobicChamp"},
    {"傻逼舞5", "Emote_Bendy"},
    {"傻逼舞6", "Emote_BandOfTheFort"},
    {"傻逼舞7", "Emote_Capoeira"},
    {"傻逼舞8", "Emote_Charleston"},
    {"傻逼舞9", "Emote_Chicken"},
    {"傻逼舞10", "Emote_Dance_NoBones",},
    {"傻逼舞11", "Emote_Dance_Shoot"},
    {"傻逼舞12", "Emote_Dance_SwipeIt"},
    {"傻逼舞13", "Emote_Dance_Disco_T3"},
    {"傻逼舞14", "Emote_DG_Disco",},
    {"傻逼舞15", "Emote_Dance_Worm"},
    {"傻逼舞16", "Emote_Dance_Loser"},
    {"傻逼舞17", "Emote_Dance_Breakdance"},
    {"傻逼舞18", "Emote_Dance_Pump",},
    {"傻逼舞19", "Emote_Dance_RideThePony"},
    {"傻逼舞20", "Emote_Dab"},
    {"傻逼舞21", "Emote_FancyFeet",},
    {"傻逼舞22", "Emote_FlossDance"},
    {"傻逼舞23", "Emote_FlippnSexy"},
    {"傻逼舞24", "Emote_Fresh"},
    {"傻逼舞25", "Emote_GrooveJam",},
    {"傻逼舞26", "Emote_guitar"},
    {"傻逼舞27", "Emote_Hiphop_01"},
    {"傻逼舞28", "Emote_KoreanEagle",},
    {"傻逼舞29", "Emote_Kpop_02"},
    {"傻逼舞30", "Emote_LivingLarge"},
    {"傻逼舞31", "Emote_Maracas"},
    {"傻逼舞32", "Emote_PopLock"},
    {"傻逼舞33", "Emote_PopRock"},
    {"傻逼舞34", "Emote_RobotDance"},
    {"傻逼舞35", "Emote_T-Rex",},
    {"傻逼舞36", "Emote_TechnoZombie"},
    {"傻逼舞37", "Emote_Twist"},
    {"傻逼舞38", "Emote_Wiggle"},
    {"傻逼舞39", "Emote_Youre_Awesome"}
}

local lastModel = models[1][1]

local REFERENCE = gui.Reference( "Visuals", "Other" )
local GBOX = gui.Groupbox( REFERENCE, "大厅人物模型修改器", 328, 365, 298, 0 )

local MODEL = gui.Combobox( GBOX, "model.change", "模型修改", "" )

local DANCE = gui.Combobox( GBOX, "model.dance", "动作修改", "" )
local APPLY_DANCE = gui.Button( GBOX, "刷新动作", function()
...
local MODEL_CHANGECOLOR = gui.Checkbox( GBOX, "model.changecolor", "模型颜色", false )
