...
local BOX = gui.Groupbox(TAB, "第三人称开镜透明 免费汉化版 原作者：atk3001", 15, 15, 605, 500)
...
local switchoc = gui.Checkbox(BOX, "lua_transparent_on_scope_switchoc", "开镜后关闭不可见部位上色", false)
