...
local screenX, screenH = draw.GetScreenSize();
local x = screenX / 2;
local y = screenH / 2;
local speed = 3
...
local a = 255
   ...
   draw.Color(v, r,g,b,a)
   draw.Line(x, y, x, y - 15);
   draw.Line(x, y - 15, x + 15, y - 15);

   draw.Line(x, y, x + 15, y);
   draw.Line(x + 15, y, x + 15, y + 15);
...
callbacks.Register( "Draw", "xhair", xhair );
